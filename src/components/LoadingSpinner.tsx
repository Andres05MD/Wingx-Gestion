        ...
        <div className="min-h-screen bg-gradient-to-br from-zinc-950 via-zinc-900 to-zinc-950 p-6 flex items-center justify-center">
            <div className="text-center">
                ...
                <div className="relative inline-flex">
                    <div className="w-16 h-16 border-4 border-zinc-700 border-t-purple-500 rounded-full animate-spin"></div>
                ...
                {/* Mensaje */}
                <p className="mt-6 text-zinc-400 font-medium animate-pulse">{message}</p>
