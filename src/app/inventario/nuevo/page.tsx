                ...
                <div className="mb-8 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-zinc-400 mt-1">Registrar prendas disponibles para venta inmediata</p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="md:bg-gradient-to-br md:from-white/5 md:to-transparent md:backdrop-blur-xl md:rounded-3xl md:border md:border-white/10 md:p-8 md:shadow-2xl md:shadow-black/20">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    >
                                        ...
                                        {garments.map(g => (
                                            <option key={g.id} value={g.id} className="text-zinc-900 bg-white">
                                                {g.name}
                                            </option>
                                        ))}
                                    </select>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-4 rounded-xl bg-black/30 border border-white/10 focus:border-emerald-500/50 focus:bg-black/40 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all text-white placeholder-zinc-500 text-lg font-mono"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                <label className="flex items-center gap-2 text-sm font-semibold text-zinc-300 uppercase tracking-wider">
                                    <Palette className="w-4 h-4 text-zinc-100" />
                                    Color / Variante
                                    <span className="text-xs text-zinc-500 normal-case">(Opcional)</span>
                                </label>
                                <input
                                    type="text"
                                    ...
                                    className="w-full px-4 py-4 rounded-xl bg-black/30 border border-white/10 focus:border-pink-500/50 focus:bg-black/40 focus:ring-4 focus:ring-pink-500/10 outline-none transition-all text-white placeholder-zinc-500 text-lg"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col-reverse md:flex-row items-stretch md:items-center justify-between gap-3 md:gap-4 pt-6 md:pt-4 border-t border-white/10 md:border-none">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="group px-8 py-4 md:py-3 lg:py-4 rounded-xl bg-zinc-900 border border-zinc-800 hover:from-emerald-600 hover:to-teal-600 disabled:from-zinc-600 disabled:to-zinc-600 text-white font-bold transition-all duration-300 shadow-lg shadow-black/40 hover:shadow-black/40 disabled:shadow-none flex justify-center items-center gap-2"
                        >
