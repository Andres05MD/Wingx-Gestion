    ...
    for (let day = 1; day <= daysInMonth; day++) {
        ...
        desktopCalendarDays.push(
            <div key={day} onClick={() => handleDayClick(day)}
                className="min-h-[8rem] p-2 relative group transition-all cursor-pointer border-b border-r border-white/5 last:border-r-0 hover:bg-white/3 flex flex-col">
    ...
    return (
        <div className="space-y-3 md:space-y-6 flex flex-col h-[calc(100dvh-140px)] md:h-[calc(100vh-100px)] bg-black md:pb-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-6 shrink-0">
                ...
                <div className="flex items-center gap-4 bg-linear-to-br from-white/5 to-white/1 backdrop-blur-xl p-1.5 rounded-2xl border border-white/10 shadow-lg shadow-black/10 self-center md:self-auto">
                ...
                {view === 'calendar' ? (
                    <>
                        ...
                        <div className="md:hidden flex flex-col flex-1 overflow-hidden">
                            {/* Compact Grid */}
                            <div className="bg-linear-to-br from-white/3 to-white/[0.005] rounded-2xl border border-white/10 p-2 shrink-0">
                        ...
                        {/* ── DESKTOP Calendar ── */}
                        <div className="hidden md:flex flex-col flex-1 bg-linear-to-br from-white/3 to-white/[0.005] backdrop-blur-xl rounded-3xl border border-white/10 shadow-2xl shadow-black/20 overflow-hidden">
                    ...
                    /* ── LIST VIEW ── */
                    <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-linear-to-br from-white/3 to-white/[0.005] rounded-3xl border border-white/10">
                        {Array.from({ length: daysInMonth }, (_, i) => i + 1).map(day => {
                            ...
                            return (
                                <div key={day} className={`flex gap-4 p-4 rounded-2xl border transition-all ${isToday ? 'bg-white/3 border-white/20 shadow-lg shadow-black/40' : 'bg-transparent border-white/5 hover:bg-white/2'}`}>
            ...
            {selectedEvent && (
                <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center md:p-4 bg-black/60 backdrop-blur-md animate-in fade-in duration-200">
                    <div className="bg-linear-to-br from-zinc-900 to-zinc-950 rounded-t-3xl md:rounded-3xl w-full max-w-sm border border-white/10 shadow-2xl shadow-black/50 animate-in slide-in-from-bottom-4 md:zoom-in-95 duration-200 p-6 md:p-8 space-y-5 relative overflow-hidden">
            ...
            {showModal && !selectedEvent && (
                <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center md:p-4 bg-black/60 backdrop-blur-md animate-in fade-in duration-200">
                    <div className="bg-linear-to-br from-zinc-900 to-zinc-950 rounded-t-3xl md:rounded-3xl w-full max-w-sm border border-white/10 shadow-2xl shadow-black/50 animate-in slide-in-from-bottom-4 md:zoom-in-95 duration-200 p-6 md:p-8 space-y-5">
