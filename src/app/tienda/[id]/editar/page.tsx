        ...
        try {
            ...
            if (product) {
                ...
                if (product.categories) {
                    ...
                    setCategories([(product as any).category]);
                } else {
                    setCategories([]);
                }
                ...
                setCustomColorMap(product.customColorMap || {});
                ...
                <div className="mb-8 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-zinc-400 mt-1">Modificar detalles de la prenda</p>
                        </div>
                    </div>
                </div>
                                                    ...
                                                    <button
                                                        ...
                                                        onClick={() => {
                                                            if (!categories.includes(cat)) {
                                                                // If switching main, reset to new main
                                                                setCategories([cat]);
                                                            }
                                                        }}
